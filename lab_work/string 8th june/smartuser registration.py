''' ---------------Smart User Registration System ---------------------------------------------- A company is creating a registration portal for new employees. The system asks the user to enter the following information: Enter Full Name: anuj kumar Enter Email ID: anuj.kumar@company.com The HR team wants the system to automatically validate and process the entered information. Tasks 1. Display the employee's name in uppercase.  
2. Display the employee's name in title case. 3. Count the total number of characters in the name. 4. Count the number of spaces in the name. 5. Check whether the email contains "@". 6. Check whether the email ends with ".com". 7. Extract and displays the company name from the email. 8. Replace all spaces in the employee name with underscores (_). 9. Check whether the employee's name starts with the letter "A".  
10. Count how many times the letter "a" appears in the employee's name. Sample Input Name: anuj kumar Email: anuj.kumar@company.com Sample Output ANUJ KUMAR Anuj Kumar Total Characters: 10 Spaces: 1 Valid Email: Yes Ends With .com: Yes Company Name: company Name with Underscore: anuj_kumar Starts With A: True Count of 'a': 2 ------------------------------------------------------------'''
